...
The actual library version is taken from https://github.com/openssl/openssl with tag 'openssl-3.4.2'
...
```
    # clone the repo
    git clone -b 3.4.2 https://github.com/apotocki/openssl-iosx
...
```
    use_frameworks!
    pod 'openssl-iosx', '~> 3.4.2' 
    # or optionally more precisely
    # pod 'openssl-iosx', :git => 'https://github.com/apotocki/openssl-iosx', :tag => '3.4.2.0'
```    
