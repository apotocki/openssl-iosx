...
The actual library version is taken from https://github.com/openssl/openssl with tag 'openssl-3.0.9'
...
```
    # clone the repo
    git clone -b 3.0.9 https://github.com/apotocki/openssl-iosx
...
```
    use_frameworks!
    pod 'openssl-iosx', '~> 3.0.9' 
    # or optionally more precisely
    # pod 'openssl-iosx', :git => 'https://github.com/apotocki/openssl-iosx', :tag => '3.0.9.0'
```    
