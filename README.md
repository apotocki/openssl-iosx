...
Supported 3.2.X versions: 3.2.0

Supported 3.1.X versions: 3.1.4, 3.1.3, 3.1.2, 3.1.1, 3.1.0

Supported 3.0.X versions: 3.0.12, 3.0.11, 3.0.10, 3.0.9, 3.0.8, 3.0.8, 3.0.7
...
```
    use_frameworks!
    pod 'openssl-iosx', '~> 3.2.0'
    # or optionally more precisely
    # pod 'openssl-iosx', :git => 'https://github.com/apotocki/openssl-iosx', :tag => '3.2.0.0'
```    
