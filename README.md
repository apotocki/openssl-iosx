...
The actual library version is taken from https://github.com/openssl/openssl with tag 'openssl-3.3.4'
...
```
    # clone the repo
    git clone -b 3.3.4 https://github.com/apotocki/openssl-iosx
...
```
    use_frameworks!
    pod 'openssl-iosx', '~> 3.3.4' 
    # or optionally more precisely
    # pod 'openssl-iosx', :git => 'https://github.com/apotocki/openssl-iosx', :tag => '3.3.4.0'
```    
