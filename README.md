...
## OpenSSL 4.0.0 for Apple Platforms

This branch contains build scripts for producing OpenSSL static libraries packaged as XCFrameworks for Apple platforms, based on the **upstream OpenSSL 4.0.0 release**.
...
using the corresponding upstream tag (for example `openssl-4.0.0`).
...
git clone -b 4.0.0 https://github.com/apotocki/openssl-iosx
...
The presence of a GitHub Release for this OpenSSL version indicates a successful CI build for 4.0.0.
