...
The actual library version is taken from https://github.com/openssl/openssl with tag 'openssl-3.5.3'
...
```
    # clone the repo
    git clone -b 3.5.3 https://github.com/apotocki/openssl-iosx
