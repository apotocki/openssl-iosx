...
Supported version: 3.0.10

This repo provides a universal script for building static OpenSSL libraries for use in iOS and Mac OS X applications.
The actual library version is taken from https://github.com/openssl/openssl with tag 'openssl-3.0.10'
...
```
    # clone the repo
    git clone -b 3.0.10 https://github.com/apotocki/openssl-iosx
...
```
    use_frameworks!
    pod 'openssl-iosx', '~> 3.0.10' 
    # or optionally more precisely
    # pod 'openssl-iosx', :git => 'https://github.com/apotocki/openssl-iosx', :tag => '3.0.10.0'
```    
