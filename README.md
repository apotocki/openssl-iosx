...
## OpenSSL 3.6.3 for Apple Platforms

This branch contains build scripts for producing OpenSSL static libraries packaged as XCFrameworks for Apple platforms, based on the **upstream OpenSSL 3.6.3 release**.
...
using the corresponding upstream tag (for example `openssl-3.6.3`).
...
git clone -b 3.6.3 https://github.com/apotocki/openssl-iosx
...
```ruby
use_frameworks!
pod 'openssl-iosx', '~> 3.6.3'
# or pin to a specific tag
# tags are formatted as <openssl_version>.<package_patch>, e.g. 3.6.3.0
# pod 'openssl-iosx', :git => 'https://github.com/apotocki/openssl-iosx', :tag => '3.6.3.0'
```
...
The presence of a GitHub Release for this OpenSSL version indicates a successful CI build for 3.6.3.
