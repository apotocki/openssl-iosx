...
The actual library version is taken from https://github.com/openssl/openssl with tag 'openssl-3.1.7'
...
```
    # clone the repo
    git clone -b 3.1.7 https://github.com/apotocki/openssl-iosx
